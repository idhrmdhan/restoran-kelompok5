...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="generate_laporan.php" class="visible-phone"><i class="icon icon-print"></i> <span>Cetak</span></a>
  <ul>
    <?php
    if($r['id_level'] == 1){
  ?>
    ...
    <li class="active"> <a href="generate_laporan.php"><i class="icon icon-print"></i> <span>Riwayat Transaksi</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="generate_laporan.php" title="Go to here" class="tip-bottom"><i class="icon icon-print"></i> Riwayat Transaksi</a></div>
  </div>
<!--End-breadcrumbs-->
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Restoran <a href="#">NusaRasa</a> </div>
</div>
